...
\tikzset{every syndrome node/.style={draw,minimum width=5cm,minimum height=3cm,inner sep=1mm,outer sep=0pt,cap=round,add font=\sffamily}}
...
\tikzset{every lutcomponent node/.style={draw,minimum width=2cm,minimum height=2cm,inner sep=1mm,outer sep=0pt,cap=round,add font=\sffamily}}
...
\tikzset{every bch node/.style={draw,minimum width=5cm,minimum height=3cm,inner sep=1mm,outer sep=0pt,cap=round,add font=\sffamily}}
\tikzset{every memaster node/.style={draw,minimum width=6cm,minimum height=3cm,inner sep=1mm,outer sep=0pt,cap=round,add font=\sffamily}}
\tikzset{every lut node/.style={draw,minimum width=5cm,minimum height=3cm,inner sep=1mm,outer sep=0pt,cap=round,add font=\sffamily}}
\tikzset{every corr node/.style={draw,minimum width=5cm,minimum height=3cm,inner sep=1mm,outer sep=0pt,cap=round,add font=\sffamily}}
...
\pgfdeclareshape{utcorr}{
  ...
  % This is redundant, but makes some things easier:
    ...
    \backgroundpath{
        ...
        \pgf@anchor@utcorr@Err
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Err}}
...
\pgfdeclareshape{bch}{
  ...
  % This is redundant, but makes some things easier:
    ...
    \anchor{text}{
        \pgfpointorigin
        \advance\pgf@x by -.5\wd\pgfnodeparttextbox%
        \advance\pgf@y by -.5\ht\pgfnodeparttextbox% \advance\pgf@y by +.5\dp\pgfnodeparttextbox%
    }
    ...
    \backgroundpath{
        ...
        \pgf@anchor@bch@Wr
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Wr}}

        \pgf@anchor@bch@Rd
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Rd}}

        \pgf@anchor@bch@Addr
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Addr}}

        \pgf@anchor@bch@Resetn
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Reset\_n}}
        ...
        \pgf@anchor@bch@Irqn
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{Irq\_n}}
        \endgroup
    }
}
...
\pgfdeclareshape{memaster}{
  ...
  % This is redundant, but makes some things easier:
    ...
    \backgroundpath{
        ...
        \pgf@anchor@memaster@Words
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Words}}

        \pgf@anchor@memaster@Decode
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Decode}}

        \pgf@anchor@memaster@Syndrome
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Syndrome}}

        \pgf@anchor@memaster@EndSyndrome
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{End\_Syndrome}}

        \pgf@anchor@memaster@EndLut
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{End\_Lut}}

        \pgf@anchor@memaster@EndCorr
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{End\_Corr}}

        \pgf@anchor@memaster@Reset
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Reset}}
        ...
        \pgf@anchor@memaster@StartSyndrome
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{Start\_Syndrome}}

        \pgf@anchor@memaster@StartLut
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{Start\_Lut}}

        \pgf@anchor@memaster@StartCorr
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{Start\_Corr}}

        \pgf@anchor@memaster@AskIrq
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{Ask\_Irq}}

        \pgf@anchor@memaster@RazErr
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{RazErr}}
...
\pgfdeclareshape{lut}{
  ...
  % This is redundant, but makes some things easier:
    ...
    \backgroundpath{
        ...
        \pgf@anchor@lut@Start
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Start}}

        \pgf@anchor@lut@Reset
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Reset}}

        \pgf@anchor@lut@Syndrome
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Syndrome}}
        ...
        \pgf@anchor@lut@LdErr
        \pgftext[right,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=-\pgfshapeinnerxsep]{\raisebox{-.75ex}{LdErr}}
...
\pgfdeclareshape{corr}{
  ...
  % This is redundant, but makes some things easier:
    ...
    \backgroundpath{
        ...
        \pgf@anchor@corr@Pone
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{P1}}

        \pgf@anchor@corr@Ptwo
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{P2}}

        \pgf@anchor@corr@Reset
        \pgftext[left,base,at={\pgfpoint{\pgf@x}{\pgf@y}},x=\pgfshapeinnerxsep]{\raisebox{-0.75ex}{Reset}}
