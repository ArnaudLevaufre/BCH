        ...
        \section{Correcteur}
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[>=stealth, scale=0.6, every node/.style={scale=0.6}, circuit logic US]
                    ...
                    \draw[->, double] (counter.Q) -- +(16, 0) node[anchor=west] {Count};
        ...
        \section{Interface Avalon}
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[>=stealth, scale=1, every node/.style={scale=1}, circuit logic US]
                    ...
                    \draw[<-] (avalon.InitFifo) -- +(2, 0) node[anchor=west] {InitFifo};
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[>=stealth, scale=0.5, every node/.style={scale=0.5}, circuit logic US]
                    ...
                    \foreach [count=\ni] \txt in {Addr, R, W, Din, Dout, Irq\_n}{
                        \draw[-] (-0.5 + 0.5*\ni, 0) -- (-0.5 + 0.5*\ni, 40) node[anchor=base] {\rotatebox{90}{\txt}};
                    }

                    \foreach [count=\ni] \txt in {Decod, Words, FifoOut, CorrOutLd, CorrOut, InitFifo, Ask\_irq}{
                        \draw[-] (30.5 - 0.5*\ni, 0) -- (30.5 - 0.5*\ni, 40) node[anchor=base] {\rotatebox{90}{\txt}};
                    }
                    ...
                    \draw (fifo.Init) -| +(-0.5, 1) -- +(13.5, 1) node[connectionpoint] {};
                    ...
                    \draw (irq.S) |- +(12, -0.25) node[connectionpoint] {};
                    ...
                    \draw (decode.R) |- +(12, 0.25) node [connectionpoint] {};
                    ...
                    \draw (words.Raz) -| +(-0.5, -1.75) -- +(12.95, -1.75) node [connectionpoint] {};
