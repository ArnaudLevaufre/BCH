...
\begin{document}
    ...
    \chapter{Étude du circuit}
        ...
        \section{Look up table}
            ...
            \label{sec:uc_lut}
            L'unité de controle est définie par la machine à état présentée en figure~\ref{fig:uc_lut}.
            Elle est chargée de controller l'incrementation de P1 et P2 et le
    ...
    \chapter{Développement du code VHDL}
        ...
        \section{Correcteur}
            ...
            \paragraph{}
                ...
                % TODO Screenshots des differents cas 
    ...
    \begin{appendices}
        ...
        \paragraph{}
        Dans le code applicatif présenté ci-dessous, nous réalisons un test de
        fonctionnement des demandes d'interruptions et d'appel de la routine
        d'interruption, si celle-ci à été préalablement autorisée. Nous envoyons
        deux séries de 4 messages, chacune allant progressivement de 0 erreurs
        pour le premier message, à trois erreurs pour le quatrième. Dans les
        trois premiers cas, on s'attends à ce que au final, le bon message
        soit récupéré. Le dernier cependant, comportant trois erreurs, sera
        corrigé en un message qui n'est pas le message d'origine. Cela est du
        au fait que ce modèle de BCH ne peut corriger que deux erreurs au
        maximum, et en détecter jusqu'à trois.
        ...
        fonctionnement souhaité qui réalisé. Afin d'être certain que les
        ...
        \paragraph{}
        1 Hello from Nios II!\\2 Status: 0x3\\3 Control: 0x0
        \\4 Status: 0x1\\5 Status: 0x1\\6 Status: 0x1\\7 Status 1: 0x5
        \\8 Control 1: 0x2\\9 Status 2: 0x5
        \\10 Error 1: 0x0, Data: 0x1A0BD5; Status: 0x0; Ctrl: 0x2
        \\11 Error 2: 0x1, Data: 0x1A0BD5; Status: 0x1; Ctrl: 0x2
        \\12 Error 3: 0x2, Data: 0x1A0BD5; Status: 0x1; Ctrl: 0x2
        \\13 Error 4: 0x3, Data: 0x1A1AD4; Status: 0x3; Ctrl: 0x2
        \\14 Status 3: 0x3\\15 First pass with irqs enabled done!
        \\16 Status: 0x1\\17 Status: 0x1\\18 Status: 0x1\\19 Status: 0x5
        \\20 Control: 0x0
        \\21 Second pass with irqs disabled done! $irq_n=0$ but no ISR called
        \\22 Control: 0x0\\23 Status: 0x5
        \\24 Error: 0x0, Data: 0x1A0BD5; Status: 0x1; Ctrl: 0x0
        \\25 Error: 0x1, Data: 0x1A0BD5; Status: 0x1; Ctrl: 0x0
        \\26 Error: 0x2, Data: 0x1A0BD5; Status: 0x1; Ctrl: 0x0
        \\27 Error: 0x3, Data: 0x1A1AD4; Status: 0x3; Ctrl: 0x0
