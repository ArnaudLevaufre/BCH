...
\begin{document}
    ...
    \chapter{Développement du code VHDL}
        ...
        \section{Calcul du syndrome}
            ...
            ru sujet. On place en entrée la valeur \verb$0x435A0BD5$ et on s'attend
            à obtenir un syndrome de 0 apres les 31 coups d'horloge. On place
            ensuite des valeurs ayant des erreur et on vérifie que les
            syndromes correspondent a des syndromes non null. La validité du
            syndrome dans la Look Up Table peut être vérifier manuellement et
            sera vérifiée automatiquement par la suite de test de l'assemblage
            syndrome/lut.
