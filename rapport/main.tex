...
\begin{document}
    ...
    croisés est représenté par un points. Deux câbles croisés sans points ne se
    ...
    \chapter{Étude du circuit}
        ...
        interface Avalon fonctionnelle.
            ...
            \begin{figure}[H]
                ...
                \end{tikzpicture}
                \caption{Vue extérieur du bloques BCH}
                \label{fig:bch}
            \end{figure}

            \subsection{Sous ensembles fonctionnels du bloque BCH}
            \label{sec:fonc_bch}
            ...
            \begin{figure}[H]
                ...
                \end{tikzpicture}
                \caption{Vue intérieure du bloque BCH}
        ...
        \section{Look up table}
            ...
            \label{sec:uc_lut}
            L'unité de contrôle est définie par la machine à état présentée en figure~\ref{fig:uc_lut}.
        ...
        \section{Interface Avalon}
            ...
            utilisée en interne par composant. Ces groupes sont présenté
            respectivement à gauche et droite du bloque avalon dont le schéma
            ...
            \begin{figure}[H]
                ...
                \end{tikzpicture}
                \caption{Vue extérieur du bloque avalon}
            ...
            sortie interne au bloque BCH à droite. Les liaisons se lisent de la
            même façon que dans Qsys. On trouve ensuite un décodeur d'adresse,
            bloque combinatoire qui permet de transformer l'adresse donné au
            bloque avalon en une sélection de registre de statu, contrôle ou
            donnée. La pile Fifo est intégrée au bloque avalon car elle sert à
            ...
            traiter au démarrage du BCH. Le compteur est nécéssaire car la pile
    ...
    quartus est compilé et flashé il est nécessaire d'implémenter une api
    permettant d'utiliser le composant de façon assez confortable. L'api que
    nous proposons est assez riche.
    ...
    alors la responsabilité d'utiliser les opérateurs logique «~et~» et «~ou~»
    ...
    d'accéder à une information ciblé du statu~:
    \begin{itemize}
    ...
    avoir a manipuler manuellement le registre de contrôle. Les fonctions sont
    les suivantes~:
    \begin{itemize}
    ...
    \chapter{Application de démonstration}
        ...
        pour le quatrième. Dans les trois premiers cas, on s'attend à ce que
